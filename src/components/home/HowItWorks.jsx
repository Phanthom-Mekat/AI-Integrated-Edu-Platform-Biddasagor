...
const HowItWorks = () => {
    return (
        ...
        >
            <div>
                <h2
                    className="text-4xl text-center font-bold text-secondary pt-5 mb-4"
                    data-aos="fade-up"
                >
                    How It Works
                </h2>
                <p
                    ...
                    data-aos-delay="200"
                >
                    Empower parents with an easy-to-use platform to create personalized exercises based on their children’s needs. From uploading problems to tracking progress, it’s all made simple!
                </p>
            </div>
            <ul
            ...
            >
                ...
                <li data-aos="fade-right" data-aos-anchor-placement="center-bottom">
                    ...
                    <div className="timeline-start mb-10 md:text-end">
                        ...
                        <p className="text-gray-600">
                            Upload a picture or select a topic to generate a chatbot math problem to get started.
                        </p>
                    </div>
                    <hr />
                </li>
                ...
                <li data-aos="fade-left" data-aos-anchor-placement="center-bottom">
                    ...
                    <div className="timeline-end mb-10">
                        ...
                        <p className="text-gray-600">
                            Our AI recreates math problems with a school-like feel for practice.
                        </p>
                    </div>
                    <hr />
                </li>
                ...
                <li data-aos="fade-right" data-aos-anchor-placement="center-bottom">
                    ...
                    <div className="timeline-start mb-10 md:text-end">
                        ...
                        <p className="text-gray-600">
                            Play a quiz to test your understanding of the problem.
                        </p>
                    </div>
                    <hr />
                </li>
                ...
                <li data-aos="fade-left" data-aos-anchor-placement="center-bottom">
                    ...
                    <div className="timeline-end mb-10">
                        ...
                        <p className="text-gray-600">
                            Review answers and track progress through the app for better insights.
                        </p>
                    </div>
                    <hr />
                </li>
                ...
                <li data-aos="fade-right" data-aos-anchor-placement="center-bottom">
                    ...
                    <div className="timeline-start mb-10 md:text-end">
                        ...
                        <p className="text-gray-600">
                            Visualize learning trends and improvements with saved results.
                        </p>
                    </div>
                    <hr />
                </li>
