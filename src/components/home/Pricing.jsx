...
const Pricing = () => {
    return (
        <div className="bg-light py-16 w-11/12 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Basic Plan */}
                <div className="border-2 border-secondary rounded-lg shadow-lg p-6 text-center bg-primary/10">
                ...
                {/* Pro Plan */}
                <div className="border-8 border-secondary rounded-lg shadow-lg p-6 text-center bg-secondary/20">
                ...
                {/* Premium Plan */}
                <div className="border-2 border-secondary rounded-lg shadow-lg p-6 text-center bg-primary/15">
