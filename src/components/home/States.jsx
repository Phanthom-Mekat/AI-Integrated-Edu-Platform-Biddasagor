...
const States = () => {
    return (
        <div className="bg-tertiary/25 pt-80 md:pt-40 pb-16"  style={{
            ...
            <div className="flex justify-around max-md:flex-col md:flex-row gap-10">
                ...
                <div className="flex flex-col items-center text-center  p-6 rounded-lg ">
                    ...
                    <CountUp start={0} end={20000} duration={30} separator="," className="text-3xl font-bold text-primary" />
                ...
                <div className="flex flex-col items-center text-center  p-6 rounded-lg ">
                    ...
                    <CountUp start={0} end={15000} duration={40} separator="," className="text-3xl font-bold text-primary" />
                ...
                <div className="flex flex-col items-center text-center p-6 rounded-lg ">
                    ...
                    <CountUp start={0} end={500} duration={20} separator="," className="text-3xl font-bold text-primary" />
                ...
                <div className="flex flex-col items-center text-center  p-6 rounded-lg ">
                    ...
                    <CountUp start={0} end={1200} duration={20} separator="," className="text-3xl font-bold text-primary" />
